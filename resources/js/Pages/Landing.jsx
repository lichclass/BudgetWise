...
import JoinUsBtn from "../../../public/build/assets/JoinUsBtn.svg";
    ...
    return (
        <LandingLayout>
            ...
            <div className="flex flex-col items-center justify-center h-full w-full">
                <h1 className="text-5xl font-bold text-white text-center w-full md:w-5/12">
                ...
                <div className="flex w-5/6 md:w-2/5 py-5">
                    ...
                    <div className="flex flex-col justify-between">
                        <p className="text-white">
                            BudgetWise is here to help you save smart, budget
                            better, and reach your financial goals without all
                            the fuss
                        </p>
                        <Link
                            href={route("register")}
