...
const btnActive =
    "border border-teal-700 bg-teal-700 text-white text-md py-3 px-11 rounded-xl shadow-sm";
const btnInactive =
...
const checkboxLabelStyle =
    "size-label px-4 py-2 border text-slate-800 border-gray-600 font-normal rounded-2xl cursor-pointer shadow-sm transition-colors peer-checked:bg-teal-700 peer-checked:border-teal-700 peer-checked:text-white";
                ...
                {step === 2 && (
                    <div>
                        <AuthInputField
                            ...
                            type="text"
                            name="ledger-name"
                            placeholder="Ex. Personal, Business, etc."
